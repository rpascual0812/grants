...
import { DataCollectionComponent } from 'src/app/pages/data-collection/data-collection.component';
...
export const MainLayoutRoutes: Routes = [
    ...
    { path: 'data-collection', component: DataCollectionComponent, canActivate: [authGuard] },

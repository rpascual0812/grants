...
@Component({
    selector: 'app-common-grants-per-country-chart',
    templateUrl: './common-grants-per-country-chart.component.html',
    styleUrls: ['./common-grants-per-country-chart.component.scss'],
})
export class CommonGrantsPerCountryChartComponent implements OnInit {
    loading = true;
